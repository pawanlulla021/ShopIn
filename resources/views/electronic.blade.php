...
<head>
    ...
    <title>Shop in | electronic</title>
				...
				<div class="row">
                  ...
                  <ul role="menu" class="sub-menu">
                    <li><a href="/user/men">Men</a></li>
										...
										<li><a href="/user/electronic" class="active">Electronics</a></li> 
                  </ul>
                </li> 
			...
			<div class="row">
				...
				<div>
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">In Electronics</h2>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									...
									<img src="{{asset('admin_images/' .$witem->sub_galary)}}" style="width:160px; height:220px " alt="women">

			...
			<div class="container">
				<div class="row">
                  ...
                  <ul role="menu" class="sub-menu">
                    <li><a href="/user/men" class="active">Men</a></li>
			...
			<div class="row">
				...
				<div>
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">In Men</h2>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									...
									<img src="{{asset('admin_images/' .$witem->sub_galary)}}" style="width:200px; height:360px" alt="women">
